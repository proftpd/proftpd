  ...
  my $config = {
    ...
    IfModules => {
      ...
      'mod_sql.c' => {
        ...
        SQLConnectInfo => $db_file,
        SQLLogFile => $log_file,
        SQLNamedQuery => 'get-sql-users SELECT "userid, passwd, uid, gid, homedir, shell FROM ftpusers WHERE userid = \'%U\'"',
        SQLUserInfo => 'custom:/get-sql-users',
      },
    },
  };
  ...
  my $config = {
    ...
    IfModules => {
      ...
      'mod_sql.c' => [
        ...
        'SQLUserInfo custom:/get-user-info/get-all-users',
      ],
    },
  };
