...
my $TESTS = {
  ...
  quotatab_stor_ok_user_limit_bytes_in_soft_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  quotatab_stor_ok_user_limit_bytes_in_hard_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },
  ...
  quotatab_stor_ok_group_limit_bytes_in_soft_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  quotatab_stor_ok_group_limit_bytes_in_hard_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },
  ...
  quotatab_stor_ok_class_limit_bytes_in_soft_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  quotatab_stor_ok_class_limit_bytes_in_hard_limit_exceeded => {
    order => ++$order,
    test_class => [qw(forking)],
  },
...
sub quotatab_stor_ok_user_limit_bytes_in_soft_limit_exceeded {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
...
sub quotatab_stor_ok_user_limit_bytes_in_hard_limit_exceeded {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
...
sub quotatab_stor_ok_group_limit_bytes_in_soft_limit_exceeded  {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
...
sub quotatab_stor_ok_group_limit_bytes_in_hard_limit_exceeded  {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
...
sub quotatab_stor_ok_class_limit_bytes_in_soft_limit_exceeded {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
...
sub quotatab_stor_ok_class_limit_bytes_in_hard_limit_exceeded {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
