...
sub stru_file_ok {
  ...
  if ($pid) {
    eval {
      ...
      eval { ($resp_code, $resp_msg) = $client->stru('file') };
      if ($@) {
        my $err = $@;
        print $writeh "done\n";
        die("Failed to STRU: $err");
      }
...
sub stru_record_fails {
  ...
  if ($pid) {
    eval {
      ...
      my ($resp_code, $resp_msg);
      eval { ($resp_code, $resp_msg) = $client->stru('record') };
      unless ($@) {
        my $err = $@;
        print $writeh "done\n";
        die("STRU succeeded unexpectedly");
...
sub stru_page_fails {
  ...
  if ($pid) {
    eval {
      ...
      my ($resp_code, $resp_msg);
      eval { ($resp_code, $resp_msg) = $client->stru('page') };
      unless ($@) {
        my $err = $@;
        print $writeh "done\n";
        die("STRU succeeded unexpectedly");
...
sub stru_other_fails {
  ...
  if ($pid) {
    eval {
      ...
      my ($resp_code, $resp_msg);
      eval { ($resp_code, $resp_msg) = $client->stru('other') };
      unless ($@) {
        my $err = $@;
        print $writeh "done\n";
        die("STRU succeeded unexpectedly");
